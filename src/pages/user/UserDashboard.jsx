...
const UserDashboard = () => {
    ...
    return (
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                <div className="bg-pink-50 py-2 px-3 rounded-xl border border-pink-100 inline-block mb-3">
                    <Link to='/' className="flex"><Home className="me-2" size={20} /> Home</Link>
                </div>
                {/* Top  */}
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        <div className="">
                            ...
                            <h1 className=" text-center text-lg"><span className=" font-bold">Created Date : </span>{user.date}</h1>
