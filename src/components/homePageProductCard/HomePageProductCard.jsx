                                ...
                                <div key={index} className="p-4 w-full md:w-1/4">
                                    <div className="h-full border border-gray-300 rounded-xl overflow-hidden shadow-md cursor-pointer">
                                            <img onClick={() => navigate(`/productinfo/${id}`)}
                                                className="lg:h-80 md:h-60  h-96 w-full"
                                                src={productImageUrl}
                                                alt="blog"
                                            />
                                        <div className="lg:p-6 p-4">
                                            ...
                                            <h1 className="title-font lg:text-lg  text-sm font-medium text-gray-900 mb-3">
                                            ...
                                            <div className="flex justify-center ">
                                                ...
                                                <button onClick={() => deleteCart(item)} className=" bg-red-400 hover:bg-red-500 w-full text-white py-[4px] rounded-lg font-bold">
                                                   Delete From Cart
                                                </button>
                                                :
