                    ...
                    <table className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-pink-400" >
                        <tbody>
                            ...
                            {getAllOrder.length === 0 ?
                             ...
                             <td colSpan={16} className="text-center h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 ">
                                 No Order Here
                             </td>
                             </tr>
                             :
