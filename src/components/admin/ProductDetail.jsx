...
const ProductDetail = () => {
    ...
    const {loading, setLoading, getAllProduct, getAllProductFunction} = contaxt;
            ...
            <div className="w-full overflow-x-auto mb-5">
                <table className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-pink-400" >
                    <tbody>
                        ...
                        {getAllProduct.length === 0 ? (<tr className="text-pink-300" >
                            <td colSpan='8' className=" text-center h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 ">
                                No Product Added
                            </td>
                        </tr>) :
                        getAllProduct.map((item, index) =>{
                            ...
                            <td className="h-12 px-6 text-md text-center transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 first-letter:uppercase ">
                                <img className="w-20 mx-auto" src={productImageUrl} alt="" />
                            </td>
